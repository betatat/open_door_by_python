...
#获取账号token
get_token_url = 'https://xcx.nsspmj.cn:8020/system/user/getToken/XXXXXX?requestData=XXXXXX'
get_token_header = {
...
'withEncrypt': "1",
'Referer': 'https://servicewechat.com/wxXXXXXX/25/page-frame.html',
...
#获取开门令牌
get_secret_url = 'https://xcx.nsspmj.cn:8020/openDoor/getOpenDoorSecret/XXXXXXX'
get_secret_header = {
